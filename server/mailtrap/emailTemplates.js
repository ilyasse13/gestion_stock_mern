...
<head>
  ...
  <style>
    ...
    .header {
      background: linear-gradient(to right, #eb042b, #333);
      padding: 20px;
      text-align: center;
      color: white;
    }
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: white; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <div style="background-color: #eb042b; color: white; width: 50px; height: 50px; line-height: 50px; border-radius: 50%; display: inline-block; font-size: 30px;">
        ✓
      </div>
    </div>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: white; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="{resetURL}" style="background-color: #eb042b; color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">Reset Password</a>
    </div>
...
<body>
  ...
  <div class="container">
    ...
    <p>We are thrilled to welcome you to [Your App Name]! Thank you for joining our community. We're excited to have you on board.</p>
    
    <p>You are now part of a growing community that values innovation and efficiency. Whether you're just starting out or you're a seasoned pro, we’re here to make your experience as smooth and enjoyable as possible.</p>
    
    <p>If you have any questions or need assistance, don’t hesitate to reach out to our support team.</p>
    
    <p>Welcome again, and we hope you enjoy using [Your App Name]!</p>
